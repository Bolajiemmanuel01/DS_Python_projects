...
[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://bolaji-dashboard-project-60becfb05554.herokuapp.com/)
...
#### Git
Git is a version control system used for tracking changes in code. It is commonly used for collaborating on code and managing code changes. We used it here to clone the Pulse repository and extract the required data for analysis and also track changes made on our app from time to time.
...
#### Heroku
Heroku is a cloud platform as a service (PaaS) supporting several programming languages.  Heroku is a polyglot platform as it has features for a developer to build, run and scale applications in a similar manner across most languages. We used it here to deploy our application to the internet, and also take note of each version of our application.
...
To run the app, follow these steps:
    ...
    1. Clone the repository to your local machine using the following command: git clone [https://git.heroku.com/bolaji-dashboard-project.git].
    ...
    5. Open a terminal window and navigate to the directory where the app is located using the following command: cd [1_🔔_Home.py file directory].
    6. Run the Streamlit app using the command [streamlit run 1_🔔_Home.py] and access the app through the local URL provided.
...
<img width="956" alt="1 1" src="Images_and_logo/page1.png">

<img width="960" alt="2" src="Images_and_logo/page2.png">

<img width="957" alt="3" src="Images_and_logo/page3.png">

<img width="955" alt="4" src="Images_and_logo/page4.png">
...
If you have any questions, comments, or suggestions for the app, please feel free to contact me at [bolajiemmanuel01@gmail.com]